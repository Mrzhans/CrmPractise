...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function selectAllClue() {
                $("#mybody").empty();
                $.ajax({
                    url:"workbench/clue/selectAllClue.do",
                    dataType:"json",
                    success:function (data) {
                        html = "";
                        $.each(data,function (i,n) {
                            ...
                            html+='<td><a style="text-decoration: none; cursor: pointer;" href="workbench/clue/detail.do?id='+ n.id +'">'+ n.fullname +'</a></td>';
            ...
            <div class="modal-dialog" role="document" style="width: 90%;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="createModal">创建线索</h4>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal" role="create-form" id="create-myform">
