    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $("#selectActByName").keydown(function (event) {
                    if (event.keyCode == 13){
                        createRelation($("#selectActByName").val());
                        return false;
                    }
                })

                $("#createRelationBtn").click(function () {
                    var canshu = "";
                    ...
                    $.ajax({
                        url:"workbench/clue/createActivtiyRelation.do",
                        data:{
                            clueid:"${clue.id}",
                            activityids:canshu
                        },
            ...
            function createRelation(name){
                $("#saveActivityBody").empty();
                $.ajax({
                    url:"workbench/clue/getActivtiys.do",
                    data:{
                        clueid:"${clue.id}",
                        name:name
                    },
            ...
            function unbund(id) {
                $.ajax({
                    url:"workbench/clue/delByActivityId.do",
                    data:{
                        id:id
                    },
                    dataType:"json",
            ...
            function getActivityByClueId() {
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        ...
                        $("#clueAndActivityBody").append(html);
                    }
                })
            }
        </script>
    ...
    <body>
            ...
            <div class="modal-dialog" role="document" style="width: 80%;">
                <div class="modal-content">
                        ...
                        <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                            <form class="form-inline" role="form">
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control" style="width: 300px;" id="selectActByName"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="createRelationBtn">关联</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="position: relative; left: 40px; top: -30px;">
            ...
            <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
                <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?fullname=${clue.fullname}&company=${clue.company}&owner=${clue.owner}&id=${clue.id}'"><span
                    <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?fullname=${clue.fullname}&company=${clue.company}&owner=${clue.owner}&id=${clue.id}'"><span
        ...
        <div style="position: relative; top: -70px;">
            <div style="position: relative; left: 40px; height: 30px;">
                ...
                <div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>张三</b></div>
        ...
        <div>
            <div style="position: relative; top: 60px; left: 40px;">
                ...
                <div>
                    <a href="javascript:void(0);" style="text-decoration: none;" onclick="createRelation()"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
                </div>
            </div>
        </div>
