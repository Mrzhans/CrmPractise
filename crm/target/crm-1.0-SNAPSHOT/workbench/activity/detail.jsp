...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function editRemark(id) {
                //这个很重要，我们要修改备注信息，一定需要知道是哪个id，但是我们调用click方法没办法直接获取，就要用到隐藏域！
                $("#remarkId").val(id);
                $("#noteContent").val($("#"+id).html());
                $("#editRemarkModal").modal("show");
            }

            function selectAllRemark() {
                $("#myRemarkBody").empty();
                $.ajax({
                    url:"workbench/activity/selectAllRemark.do",
                    data:{
                        id:"${a.id}"
                    },
                    dataType:"json",
                    ...
                    success:function (data) {
                        ...
                        $.each(data,function (i,n) {
                            ...
                            html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>'+ name +'</b> <small style="color: gray;">' + n.createTime + '由'+ n.createBy + '</small>';
    ...
    <body>
        ...
        <div style="position: relative; top: 35px; left: 10px;">
            <a href="javascript:void(0);" onclick="window.history.back();"><span class="glyphicon glyphicon-arrow-left" style="font-size: 20px; color:red">
            </span></a>
        </div>
